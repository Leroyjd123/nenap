...
export function RecordingRail({ ensureNoteId, onSaved }: RecordingRailProps) {
      ...
      {recording && (
        <>
          <div className="row between" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <button className="btn btn-soft btn-sm" onClick={handleStop}><Icon name="stop" size={15} /> Stop</button>
          </div>
